      ...
      return (
        <div className="login-overlay">
          <div className="login-modal">
            <button className="login-close" aria-label="Close" onClick={handleBack}>
              &times;
            </button>
            <div className="login-logo">X</div>
            {/* ...rest of your login password modal content... */}
          </div>
        </div>
      );
      const endpoint = isSettingPassword
        ? "/auth/set-password-oauth"
        : "/auth/login";
        ...
        <form onSubmit={handlePasswordSubmit}>
          ...
          <div style={{ position: "relative", marginBottom: "16px" }}>
            <input
              ...
              placeholder={
                isSettingPassword ? "Create password (min 8 chars)" : "Password"
              }
              value={password}
              onChange={(e) => {
