      ...
      return (
        <div className="login-overlay">
          <div className="login-modal">
            ...
            {/* ...rest of your login modal content... */}
          </div>
              ...
              <button className="login-btn google" type="button">
                ...
                >
                  <g>
                    <path
                      fill="#4285F4"
                      d="M24 9.5c3.54 0 6.07 1.53 7.47 2.81l5.52-5.36C33.64 4.09 29.28 2 24 2 14.82 2 6.98 7.98 3.69 16.09l6.91 5.36C12.18 15.09 17.62 9.5 24 9.5z"
                    />
                    <path
                      fill="#34A853"
                      d="M46.1 24.55c0-1.64-.15-3.21-.42-4.73H24v9.18h12.42c-.54 2.9-2.18 5.36-4.66 7.02l7.18 5.59C43.98 37.09 46.1 31.36 46.1 24.55z"
                    />
                    <path
                      fill="#FBBC05"
                      d="M10.6 28.45c-1.09-3.21-1.09-6.68 0-9.89l-6.91-5.36C1.09 17.09 0 20.45 0 24c0 3.55 1.09 6.91 3.69 9.8l6.91-5.35z"
                    />
                    <path
                      fill="#EA4335"
                      d="M24 44c5.28 0 9.7-1.75 12.93-4.77l-7.18-5.59c-2.01 1.36-4.59 2.18-7.75 2.18-6.38 0-11.82-5.59-13.4-12.91l-6.91 5.36C6.98 40.02 14.82 46 24 46z"
                    />
