            ...
            <div className="compose-modal-input-container">
              ...
              {selectedMedia.length > 0 && (
                <div className="compose-modal-media-preview">
                  <div
                    className={`compose-modal-media-grid ${selectedMedia.length === 1 ? "single" : selectedMedia.length === 2 ? "double" : "multiple"}`}
                  >
                ...
                <div className="compose-modal-post-controls">
                  {getCharacterCount() > 0 && (
                    <div className="compose-modal-character-count-container">
                      <svg
                        className="compose-modal-character-progress"
                        viewBox="0 0 20 20"
                      >
                        <circle
                          cx="10"
                      ...
                      {getCharacterCount() > 260 && (
                        <span
                          className="compose-modal-character-count"
