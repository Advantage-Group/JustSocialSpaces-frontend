        ...
        <div className="comment-original-post">
          <div className="comment-post-header">
            ...
            <div className="comment-post-user-info">
              ...
              <span className="comment-post-user-handle">
                {" "}
                @{post.author?.email?.split("@")[0] || "user"}
              </span>
              <span className="comment-post-timestamp">
                {" "}
          ...
          {((post.images && post.images.length > 0) ||
            ...
            <div className="comment-post-images">
              <div
                className={`comment-post-image-grid ${(post.media?.length || post.images?.length || 0) === 1 ? "single" : (post.media?.length || post.images?.length || 0) === 2 ? "double" : "multiple"}`}
              >
                {post.media &&
          ...
          <div className="comment-reply-context">
            Replying to{" "}
            <span className="comment-reply-handle">
              @{post.author?.email?.split("@")[0] || "user"}
            </span>
          </div>
        </div>
          ...
          <div className="comment-input-container">
            ...
            {selectedMedia.length > 0 && (
              <div className="comment-media-preview">
                <div
                  className={`comment-media-grid ${selectedMedia.length === 1 ? "single" : selectedMedia.length === 2 ? "double" : "multiple"}`}
                >
