...
const MainLayout = ({ children }) => {
  ...
  React.useEffect(() => {
    const handleProfilePhotoUpdate = (event) => {
      console.log(
        "MainLayout: Profile photo updated event received",
        event.detail,
      );
  ...
  return (
    <div className="main-layout">
      ...
      <div className="layout-container">
        {/* Left Sidebar */}
        <div
          className={`left-sidebar ${state.sidebarCollapsed ? "collapsed" : ""}`}
        >
          ...
          <div className="user-profile-container">
            ...
            >
              <img
                ...
                src={
                  state.user?.photo
                    ? `${state.user.photo}${state.user.photo.includes("?") ? "&" : "?"}v=${avatarUpdateKey}`
